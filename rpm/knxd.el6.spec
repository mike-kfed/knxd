...
# /etc
# TODO install custom init.d file and config for init.d file
...
%changelog
* Tue Jan 10 2017 Michael Kefeder <m.kefeder@gmail.com> 0.11.18-0
- Initial spec file created and tested on CentOS 6 
